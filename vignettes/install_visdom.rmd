...
Currently, the VISDOM R module is private, so you will need an account on GitHub and then you need to be added to the list of collaborators. Once you are a collaborator, go to https://github.com/settings/tokens and generate a Personal Access Token (PAT) for repo access. This means that you will check the "repo" box for the scope of your new token.
...
```{bash eval=F}
cd /dev
git clone git@github.com:sborgeson/visdom.git
git clone https://github.com/sborgeson/visdom.git
```
